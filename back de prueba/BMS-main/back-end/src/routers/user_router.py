...
# Create User
@users_router.post("/{user_id}", status_code=201, response_model=UserResponse)
...
# Get User
@users_router.get("/{user_id}", status_code=201, response_model=UserResponse)
...
# Update User
@users_router.put("/{user_id}", status_code=201, response_model=UserResponse)
...
# Delete User
@users_router.delete("/{user_id}", status_code=201)
